...
def rotate_from_ori(euler_angle_in_degree):
    import utils.tf as tf
    ori_quat = euler2quat(np.array([135, 0., 180]))
...
if __name__ == "__main__":
    ...
    # init arms
    p = PandaArm(model_path=MODEL_PATH+'franka_panda.xml',
    ...
    wait(50)
    move_to(curr_ee, rotate_from_ori([90, 0, 0]))
    wait(50)
    move_to(curr_ee, rotate_from_ori([0, 0, 0]))
    wait(50)
    move_to(curr_ee, rotate_from_ori([0, 90, 0]))
    wait(50)
    move_to(curr_ee, rotate_from_ori([0, 0, 0]))
    wait(50)
    move_to(curr_ee, rotate_from_ori([0, 0, 90]))
    wait(50)
    move_to(curr_ee, rotate_from_ori([0, 0, 0]))
    wait(50)
    # --------------------------------------
